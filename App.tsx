...
const translations = {
  en: {
    ...
    conflictDesc:
      "These performances overlap in time, so they cannot be purchased together:",
    ...
    ticketsDesc:
      "Select the ticket type and performances, then check your cart. The total will separately show discounts and related fees.",
    cartTitle: "CART",
    ...
    feeDisclaimer:
      "Fees and discounts are demo logic. Handling fee is per item, service fee applies after discount.",
    ...
    jul: "JUL",
    gastroSubDesc:
      "Visual event-app style cards, larger typography, and clearer categories.",
    hours: "hours",
    festivalBrand: "ECLIPSEFEST · 2026",
    list: "List",
    mapDesc:
      "Select a location from the list below, and we will show you where to find it on the map.",
    ...
    favDesc:
      "In the schedule view, you can favorite the artists you don't want to miss.",
    popular: "POPULAR",
    ...
    checkoutDisabledReason:
      "Select a ticket type and at least one performance to continue",
  ...
  hu: {
    ...
    conflictDesc:
      "Ezek a fellépések átfedik egymást, ezért együtt nem vásárolhatók meg:",
    ...
    ticketsDesc:
      "Válaszd ki a jegytípust és a fellépéseket, majd ellenőrizd a kosarat. A végösszegben külön látszanak a kedvezmények és a vásárláshoz kapcsolódó díjak.",
    cartTitle: "KOSÁR",
    homeHeroSubtitle: "LIVE MUSIC · NIGHT EXPERIENCE",
    ...
    feeDisclaimer:
      "A díjak és kedvezmények demo logikák. A kezelési díj tételenként, a szolgáltatási díj a kedvezménnyel csökkentett összeg után számolódik.",
    ...
    checkoutDisabledReason:
      "Válassz jegytípust és legalább egy fellépést a folytatáshoz",
...
const MAP_POINTS_TRANSLATIONS: Record<
  string,
  Record<"en" | "hu", { name: string; description: string }>
> = {
  "main-stage": {
    en: {
      name: "Main Stage",
      description: "Main stage – headliners and big shows.",
    },
    hu: {
      name: "Main Stage",
      description: "Főszínpad – headlinerek és nagy show-k.",
    },
  },
  "electronic-stage": {
    en: {
      name: "Electronic Stage",
      description: "Electronic and house genres.",
    },
    hu: {
      name: "Electronic Stage",
      description: "Elektronikus és house műfajok.",
    },
  },
  "acoustic-stage": {
    en: {
      name: "Acoustic Stage",
      description: "Acoustic and intimate performances.",
    },
    hu: {
      name: "Acoustic Stage",
      description: "Akusztikus és intim előadások.",
    },
  },
  "sunrise-stage": {
    en: {
      name: "Sunrise Stage",
      description: "Afterparty section until dawn.",
    },
    hu: {
      name: "Sunrise Stage",
      description: "Hajnalig tartó afterparty szekció.",
    },
  },
  entrance: {
    en: {
      name: "Main Entrance",
      description: "Entry with ticket and wristband.",
    },
  ...
  "info-desk": {
    ...
    hu: {
      name: "Infópont",
      description: "Térkép, elveszett tárgyak, segítség.",
    },
  },
  "food-court": {
    en: {
      name: "Food Court",
      description: "Food and drink stands in the middle of the plaza.",
    },
    hu: {
      name: "Food Court",
      description: "Étel- és italstandok a piactér közepén.",
    },
  },
  "street-food": {
    en: {
      name: "Street Food Lane",
      description: "Fast food, burgers, tacos, desserts.",
    },
    hu: {
      name: "Street Food sáv",
      description: "Gyors ételek, burger, taco, desszert.",
    },
  },
  "bar-center": {
    en: {
      name: "Bar Center",
      description: "Cocktails, beer, and soft drinks.",
    },
  ...
  "merch-village": {
    en: {
      name: "Merch Village",
      description: "Official t-shirts, caps, souvenirs.",
    },
    hu: {
      name: "Merch Village",
      description: "Hivatalos pólók, sapkák, emléktárgyak.",
    },
  },
  "artist-merch": {
    en: {
      name: "Artist Stand",
      description: "Tour merch and limited editions.",
    },
    hu: {
      name: "Előadói stand",
      description: "Turné merch és limitált kiadások.",
    },
  },
  "photo-booth": {
    en: {
      name: "Photo Booth",
      description: "Festival photography and instant prints.",
    },
    hu: {
      name: "Fotópont",
      description: "Fesztivál fotózás és azonnali nyomat.",
    },
  },
};

const TICKET_TRANSLATIONS: Record<
  string,
  Record<
    "en" | "hu",
    { name: string; description: string; badge: string; features: string[] }
  >
> = {
  "day-pass": {
    en: {
  ...
  "vip-pass": {
    en: {
      name: "VIP Pass",
      description:
        "Premium experience for the entire duration of the festival.",
      badge: "VIP",
      features: [
        "VIP lounge",
        "Separate restroom & bar",
...
const GASTRO_STANDS_TRANSLATIONS: Record<
  string,
  Record<"en" | "hu", { description: string; offers: string[] }>
> = {
  g1: {
    en: {
      description:
        "The Haus of Gaga's official cocktail bar. Bold flavors for brave souls.",
      offers: [
        "Poker Face Paloma – grapefruit-tequila cocktail with salted rim",
        "Bad Romance Rosé – raspberry champagne cocktail with devil horns decoration",
      ],
    },
    hu: {
      description:
  ...
  g2: {
    en: {
      description:
        "13 types of drinks, one for every era. Friendship bracelets with every sip.",
      offers: [
        "Red Lemonade – strawberry lemonade with gold glitter dust",
        "Midnights Mojito – blue butterfly pea flower patterned mojito",
      ],
    },
    hu: {
      description:
  ...
  g3: {
    en: {
      description:
        "Flame-grilled, heavily seasoned dishes. Are you a believer? Then stand the heat!",
      offers: [
        "Thunder Burger – double beef patty with smoky BBQ sauce",
        "Demons Wings – hellishly spicy chicken wings in 3 intensity levels",
      ],
    },
    hu: {
      description:
  ...
  g4: {
    en: {
      description:
        "Dark, elegant, uncompromising. Personal Jesus level quality.",
      offers: [
        "Policy of Truth Wrap – smoked chicken wrap with tahini in a black tortilla",
        "Master & Servant Platter – vegan sandwich selection",
      ],
    },
    hu: {
      description:
      ...
      offers: [
        "Policy of Truth Wrap – policy of truth wrap (füstölt csirke tahinis wrap fekete tortillában)",
  ...
  g5: {
    en: {
      description:
        "Local flavors in a festival atmosphere. Just like your mom's cooking, only louder.",
      offers: [
        "Eclipse Lángos – festival-sized flatbread with sour cream and cheese",
        "Benci's Chimney Cake – cinnamon flavored, freshly baked",
      ],
    },
    hu: {
      description:
  ...
  g6: {
    en: {
      description:
        "Galactic ice creams and cold desserts. The sweet side of the solar eclipse.",
      offers: [
        "Eclipse Sundae – black coconut ice cream with gold glitter dust",
        "Meteor Waffle – fresh waffle with blueberry topping",
      ],
    },
    hu: {
      description:
  ...
  g7: {
    en: {
      description:
        "Official energy drink partner. Charge up for the next performance!",
      offers: [
        "Monster Ultra – sugar-free versions in 6 flavors",
        "Eclipse Mix – Monster + fruit juice combinations",
      ],
    },
    hu: {
      description:
  ...
  g8: {
    en: {
      description:
        "Late-night bites for those who don't want to miss anything.",
      offers: [
        "Midnight Ramen – miso broth with toasted garlic",
        "Eclipse Pad Thai – peanut-chili, vegan option available",
      ],
    },
    hu: {
...
function getRefundDeadline(performer: Performer) {
  return new Date(
    getPerformanceDate(performer).getTime() -
      REFUND_DEADLINE_HOURS * 60 * 60 * 1000,
  );
}
...
function formatScheduleDay(day: number, lang: "en" | "hu" = "hu") {
  if (lang === "en") {
    return `Jul. ${day}`;
  }
  return `Júl. ${day}`;
      ...
      <View style={styles.ticketCardBody}>
        <View style={styles.ticketCardHeader}>
          ...
          <Text style={styles.ticketPrice}>
            {formatPrice(ticket.price, ticket.currency, lang)}
          </Text>
        </View>
...
function getPerformanceConflictPairs(selectedPerformances: Performer[]) {
  ...
  for (let i = 0; i < selectedPerformances.length; i += 1) {
    for (let j = i + 1; j < selectedPerformances.length; j += 1) {
      if (
        selectedPerformances[i].day === selectedPerformances[j].day &&
        hasTimeConflict(selectedPerformances[i], selectedPerformances[j])
      ) {
...
function getEarliestUpcomingPerformance(
  selectedPerformances: Performer[],
  now: Date,
) {
  return (
    [...selectedPerformances]
      .sort(
        (a, b) =>
          getPerformanceDate(a).getTime() - getPerformanceDate(b).getTime(),
      )
      .find((p) => getPerformanceDate(p).getTime() >= now.getTime()) ??
    selectedPerformances[0] ??
    null
  );
}
...
function formatRefundDeadlineDate(
  deadline: Date | null,
  lang: "en" | "hu" = "hu",
) {
  if (!deadline) return "-";
...
const DISCOUNT_OPTIONS: {
  ...
  {
    key: "none",
    title: "Nincs kedvezmény",
    description: "Normál online ár",
    percent: 0,
  },
  {
    key: "early",
    title: "Early Bird",
    description: "Időszakos promóció · -10%",
    percent: 10,
  },
  {
    key: "student",
    title: "Diák kedvezmény",
    description: "Belépéskor igazolással · -15%",
    percent: 15,
  },
  {
    key: "bundle",
    title: "Multi-show csomag",
    description: "3+ fellépés választásakor · -8%",
    percent: 8,
    minPerformances: 3,
  },
];
...
function getDiscountOption(key: DiscountKey) {
  return (
    DISCOUNT_OPTIONS.find((option) => option.key === key) ?? DISCOUNT_OPTIONS[0]
  );
}
    ...
    switch (key) {
      case "none":
        return {
          ...option,
          title: "No discount",
          description: "Normal online price",
        };
      case "early":
        return {
          ...option,
          title: "Early Bird",
          description: "Seasonal promo · -10%",
        };
      case "student":
        return {
          ...option,
          title: "Student discount",
          description: "With ID at entry · -15%",
        };
      case "bundle":
        return {
          ...option,
          title: "Multi-show bundle",
          description: "When choosing 3+ performances · -8%",
        };
    }
  }
  return option;
...
function isDiscountAvailable(
  key: DiscountKey,
  selectedPerformanceCount: number,
) {
  const option = getDiscountOption(key);
  return (
    !option.minPerformances ||
    selectedPerformanceCount >= option.minPerformances
  );
}
...
function PerformanceTicketCard({
  performer,
  selected,
  conflicted,
  onSelect,
  ...
  return (
    ...
    >
      <View style={styles.performanceTicketVisual}>
        <Image
          source={getPerformerImage(performer.id)}
          style={styles.performanceTicketImage}
          resizeMode="cover"
        />
      </View>
      <View style={styles.performanceTicketInfo}>
        ...
        <View style={styles.performanceTicketTimeRow}>
          <Ionicons
            ...
            size={13}
            color={conflicted ? "#fb923c" : THEME.accent}
          />
          <Text
            style={[
              styles.performanceTicketTime,
              conflicted && styles.performanceTicketTimeConflicted,
            ]}
          >
            {formatPerformanceDate(performer)}
          </Text>
        </View>
      </View>
      <Ionicons
...
function TicketsScreen({
  ...
  const sortedPerformers = [...performers].sort(
    (a, b) => getPerformanceDate(a).getTime() - getPerformanceDate(b).getTime(),
  );
  const performanceDays = [...new Set(sortedPerformers.map((p) => p.day))].sort(
    (a, b) => a - b,
  );
  ...
  const selectedPerformances = sortedPerformers.filter((p) =>
  ...
  const conflictedIds = new Set(
    conflictPairs.flatMap(({ a, b }) => [a.id, b.id]),
  );
  const hasConflicts = conflictPairs.length > 0;
  const countdownTarget = getEarliestUpcomingPerformance(
    selectedPerformances,
    now,
  );
  const countdown = countdownTarget
    ? formatCountdown(getPerformanceDate(countdownTarget), now)
    : null;
  ...
  const canCheckout =
    ...
    emailValid &&
    !hasConflicts;
  const earliestRefundDeadline =
    getEarliestRefundDeadline(selectedPerformances);
  const canRequestRefund =
    selectedPerformances.length > 0 &&
    !!earliestRefundDeadline &&
    now.getTime() <= earliestRefundDeadline.getTime() &&
    !refundRequested;
  ...
  if (
    ...
    return (
      <View style={styles.ticketsScreen}>
        <ScrollView
          contentContainerStyle={styles.orderSuccessScroll}
        ...
        >
          ...
          <View style={styles.emailSentBadge}>
            ...
            <Text style={styles.emailSentText}>
              {lang === "en"
                ...
                : "Visszaigazoló e-mail sikeresen elküldve!"}
            </Text>
          </View>
          ...
          <View style={styles.orderSummaryCard}>
            ...
            <Text style={styles.orderSummaryDetail}>
              {quantity} {lang === "en" ? "pcs" : "db"} /{" "}
              {lang === "en" ? "performance" : "fellépés"} ·{" "}
              {selectedPerformances.length}{" "}
              {lang === "en" ? "performances" : "fellépés"} ·{" "}
              {lang === "en" ? "total" : "végösszeg"}:{" "}
              {formatPrice(total, selected.currency, lang)}
            </Text>
            <View style={styles.orderDivider} />
            {cartItems.map(({ performance, lineTotal }) => (
              <View key={performance.id} style={styles.orderPerformanceRow}>
                <Text style={styles.orderPerformerName}>
                  {performance.name}
                </Text>
                <Text style={styles.orderPerformerMeta}>
                  {performance.stage} ·{" "}
                  {formatPerformanceDate(performance, lang)} ·{" "}
                  {formatPrice(lineTotal, selected.currency, lang)}
                </Text>
              </View>
            ))}
            <View style={styles.orderDivider} />
            <View style={styles.cartTotalsCompact}>
              <View style={styles.cartTotalLine}>
                <Text style={styles.cartTotalLabel}>{t.subtotal}</Text>
                <Text style={styles.cartTotalValue}>
                  {formatPrice(subtotal, selected.currency, lang)}
                </Text>
              </View>
              <View style={styles.cartTotalLine}>
                <Text style={styles.cartDiscountLabel}>
                  {t.discountLabel} ·{" "}
                  {getLocalizedDiscountOption(selectedDiscount, lang).title}
                </Text>
                <Text style={styles.cartDiscountValue}>
                  − {formatPrice(discountAmount, selected.currency, lang)}
                </Text>
              </View>
              <View style={styles.cartTotalLine}>
                <Text style={styles.cartTotalLabel}>{t.handlingFee}</Text>
                <Text style={styles.cartTotalValue}>
                  {formatPrice(handlingFee, selected.currency, lang)}
                </Text>
              </View>
              <View style={styles.cartTotalLine}>
                <Text style={styles.cartTotalLabel}>{t.serviceFee}</Text>
                <Text style={styles.cartTotalValue}>
                  {formatPrice(serviceFee, selected.currency, lang)}
                </Text>
              </View>
              <View style={styles.cartGrandTotalLine}>
                <Text style={styles.cartGrandTotalLabel}>{t.payable}</Text>
                <Text style={styles.cartGrandTotalValue}>
                  {formatPrice(total, selected.currency, lang)}
                </Text>
              </View>
            </View>
          ...
          <View style={styles.countdownCard}>
            ...
            <Text style={styles.countdownTargetName}>
              {countdownTarget.name}
            </Text>
            <View style={styles.countdownGrid}>
              <View style={styles.countdownBox}>
                <Text style={styles.countdownNumber}>{countdown.days}</Text>
                <Text style={styles.countdownUnit}>{t.days}</Text>
              </View>
              <View style={styles.countdownBox}>
          ...
          <View style={styles.refundPolicyCard}>
            ...
            <Text style={styles.refundDeadlineText}>
              {lang === "en" ? "Earliest deadline" : "Legkorábbi határidő"}:{" "}
              {formatRefundDeadlineDate(earliestRefundDeadline, lang)}
            </Text>
            {refundRequested ? (
              ...
              <TouchableOpacity
                style={[
                  styles.refundBtn,
                  !canRequestRefund && styles.refundBtnDisabled,
                ]}
              ...
              >
                ...
                <Text style={styles.refundBtnText}>
                  {canRequestRefund ? t.requestRefund : t.refundExpired}
                </Text>
              </TouchableOpacity>
            )}
          </View>
      ...
      >
        ...
        <View style={styles.ticketSectionHeader}>
          ...
          <Text style={styles.ticketSectionHint}>
            {selectedPerformances.length > 0
              ? lang === "en"
                ? `${selectedPerformances.length} selected`
                : `${selectedPerformances.length} kiválasztva`
        ...
        <View style={styles.performanceAccordionList}>
          {performancesByDay.map(({ day, label, items }) => {
            ...
            const selectedCountForDay = items.filter((p) =>
              selectedPerformanceSet.has(p.id),
            ).length;
            ...
            return (
              <View
                key={day}
                style={[
                  styles.performanceDayGroup,
                  hasConflictOnDay && styles.performanceDayGroupWarning,
                ]}
              >
                <TouchableOpacity
                  style={styles.performanceDayHeader}
                  onPress={() => togglePerformanceDay(day)}
                  activeOpacity={0.85}
                >
                  <View style={styles.performanceDayHeaderLeft}>
                    <View
                      style={[
                        styles.performanceDayIcon,
                        expanded && styles.performanceDayIconActive,
                      ]}
                    >
                      <Ionicons
                        name="calendar-outline"
                        size={18}
                        color={expanded ? THEME.text : THEME.accent}
                      />
                    </View>
                    <View>
                      ...
                      <Text style={styles.performanceDaySubtitle}>
                        ...
                        {selectedCountForDay > 0
                          ? lang === "en"
                            ? `${selectedCountForDay} selected`
                            : `${selectedCountForDay} kiválasztva`
                          : t.noneSelected}
                      </Text>
                    </View>
                  </View>
                  <View style={styles.performanceDayHeaderRight}>
                    {hasConflictOnDay && (
                      <View style={styles.performanceDayWarningBadge}>
                        <Ionicons
                          name="warning-outline"
                          size={13}
                          color="#fed7aa"
                        />
                        <Text style={styles.performanceDayWarningText}>
                          {t.conflictBadge}
                        </Text>
                      </View>
                    )}
        ...
        {hasConflicts && (
          <View style={styles.performanceConflictPanel}>
            <View style={styles.performanceConflictHeader}>
              ...
              <Text style={styles.performanceConflictTitle}>
                {t.timeConflict}
              </Text>
            </View>
            ...
            {conflictPairs.map(({ a, b }) => (
              <Text
                key={`${a.id}-${b.id}`}
                style={styles.performanceConflictItem}
              >
                • {a.name} ({a.startTime}–{a.endTime}){" "}
                {lang === "en" ? "and" : "és"} {b.name} ({b.startTime}–
                {b.endTime})
              </Text>
            ))}
          </View>
          ...
          <View style={styles.discountSection}>
            ...
            <View style={styles.discountGrid}>
              {DISCOUNT_OPTIONS.map((option) => {
                const localizedOption = getLocalizedDiscountOption(
                  option.key,
                  lang,
                );
                const active = selectedDiscount === option.key;
                const disabled = !isDiscountAvailable(
                  option.key,
                  selectedPerformances.length,
                );
                return (
                  <TouchableOpacity
                    ...
                    style={[
                      styles.discountChip,
                      active && styles.discountChipActive,
                      disabled && styles.discountChipDisabled,
                    ]}
                  ...
                  >
                    <View style={styles.discountChipHeader}>
                      <Text
                        style={[
                          styles.discountChipTitle,
                          active && styles.discountChipTitleActive,
                        ]}
                      >
                        {localizedOption.title}
                      </Text>
                      {option.percent > 0 && (
                        <Text style={styles.discountChipPercent}>
                          -{option.percent}%
                        </Text>
                      )}
                    </View>
                    <Text style={styles.discountChipDescription}>
                      {disabled
                        ? lang === "en"
                          ? `Requires at least ${option.minPerformances} performances`
                          : `Legalább ${option.minPerformances} fellépés kell hozzá`
              ...
              <View key={performance.id} style={styles.cartItemRow}>
                <View style={styles.cartItemInfo}>
                  ...
                  <Text style={styles.cartItemMeta}>
                    {selected.name} · {quantity} {lang === "en" ? "pcs" : "db"}{" "}
                    · {formatPerformanceDate(performance, lang)}
                  </Text>
                </View>
            ...
            <View style={styles.cartTotals}>
              ...
              <View style={styles.cartTotalLine}>
                <Text style={styles.cartTotalLabel}>
                  {t.serviceFee} ({Math.round(SERVICE_FEE_RATE * 1000) / 10}%)
                </Text>
                <Text style={styles.cartTotalValue}>
                  {formatPrice(serviceFee, selected.currency, lang)}
                </Text>
        ...
        {selectedPerformances.length > 0 && countdownTarget && countdown && (
          <View style={styles.selectedPerformancePanel}>
            <Text style={styles.selectedPerformanceLabel}>
              {t.selectedPerformances}
            </Text>
            {selectedPerformances.map((performance) => (
              <View key={performance.id} style={styles.selectedPerformanceLine}>
                <Text style={styles.selectedPerformanceName}>
                  {performance.name}
                </Text>
                <Text style={styles.selectedPerformanceMeta}>
                  {performance.stage} ·{" "}
                  {formatPerformanceDate(performance, lang)}
                </Text>
              </View>
            ...
            <Text style={styles.selectedRefundInfo}>
              {lang === "en"
                ? "Earliest cancellation deadline: "
                : "Legkorábbi visszamondási határidő: "}
              {formatRefundDeadlineDate(earliestRefundDeadline, lang)}
            </Text>
          </View>
        )}
            ...
            <View style={styles.checkoutCartMini}>
              <View style={styles.totalRow}>
                <Text style={styles.totalLabel}>
                  {selectedPerformances.length || 0}{" "}
                  {lang === "en"
                    ? `performance${selectedPerformances.length !== 1 ? "s" : ""}`
                    : "fellépés"}{" "}
                  · {lang === "en" ? "subtotal" : "részösszeg"}
                </Text>
              ...
              {discountAmount > 0 && (
                <View style={styles.totalRow}>
                  <Text style={styles.totalLabel}>{t.discountLabel}</Text>
...
function getMapCategoryLabel(cat: MapCategory, lang: "en" | "hu") {
  switch (cat) {
    case "stage":
      return lang === "en" ? "Stage" : "Színpad";
    case "food":
      return lang === "en" ? "Food & Drink" : "Étel & ital";
    case "merch":
      return lang === "en" ? "Stand" : "Stand";
    case "service":
      return lang === "en" ? "Service" : "Szolgáltatás";
    case "entrance":
      return lang === "en" ? "Entrance" : "Bejárat";
    case "camping":
      return lang === "en" ? "Camping" : "Kemping";
    default:
      return cat;
  }
}
...
function getMapFilterLabel(filterKey: MapFilter, lang: "en" | "hu") {
  switch (filterKey) {
    case "all":
      return lang === "en" ? "All" : "Mind";
    case "stage":
      return lang === "en" ? "Stage" : "Színpad";
    case "food":
      return lang === "en" ? "Food" : "Étel";
    case "merch":
      return lang === "en" ? "Stand" : "Stand";
    case "service":
      return lang === "en" ? "Serv." : "Szolg.";
    case "entrance":
      return lang === "en" ? "Entrance" : "Bejárat";
    case "camping":
      return lang === "en" ? "Camping" : "Kemping";
        ...
        <View style={styles.mapDetailHeader}>
          ...
          <View style={styles.mapDetailBadge}>
            <Text style={styles.mapDetailBadgeText}>
              {getMapCategoryLabel(point.category, lang)}
            </Text>
          </View>
        </View>
          ...
          <View style={styles.festivalMapImageCard}>
            ...
            {selected && selectedMarker && (
              ...
              >
                <View
                  style={[
                    styles.mapImageMarkerPulse,
                    { borderColor: MAP_CATEGORY_META[selected.category].color },
                  ]}
                />
                <View
                  style={[
                    styles.mapImageMarkerPin,
                    {
                      backgroundColor:
                        MAP_CATEGORY_META[selected.category].color,
                    },
                  ]}
                >
                  <Ionicons
                    name={
                      MAP_CATEGORY_META[selected.category]
                ...
                <View style={styles.mapImageMarkerLabel}>
                  <Text
                    numberOfLines={1}
                    style={styles.mapImageMarkerLabelText}
                  >
                    {selected.name}
                  </Text>
                </View>
          ...
          {selected && (
            <View style={styles.mapSelectedNotice}>
              <Ionicons
                name="locate"
                size={15}
                color={MAP_CATEGORY_META[selected.category].color}
              />
              <Text style={styles.mapSelectedNoticeText}>
                {t.mapSelectedNotice}
                <Text style={styles.mapSelectedNoticeName}>
                  {selected.name}
                </Text>
              </Text>
            </View>
                  ...
                  >
                    ...
                    <View style={styles.mapPointItemText}>
                      ...
                      <Text style={styles.mapPointItemCategory}>
                        {getMapCategoryLabel(item.category, lang)}
                      </Text>
                    </View>
                    <Ionicons
                      name={
            ...
            {MAP_FILTERS.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    {getMapFilterLabel(item.key, lang)}
                  </Text>
                </TouchableOpacity>
              );
            })}
...
function HomeScreen({
  ...
  const player = useVideoPlayer(
    require("./assets/video/projektvideo.mp4"),
    (playerInstance) => {
  ...
  const featuredLineup = (
    ((festivalData as any).performers ?? []) as Performer[]
  ).slice(0, 5);
    ...
    <View style={styles.homeScreen}>
      ...
      >
        ...
        {nextFav && minsUntil !== null && (
          ...
          >
            ...
            <Text style={styles.nextFavText}>
              {lang === "en" ? "Next favorite: " : "Következő kedvenced: "}
        ...
        <View style={styles.infoRow}>
          {[
            {
              label: lang === "en" ? "LOCATION" : "HELYSZÍN",
              value: "Budapest",
            },
            {
              label: lang === "en" ? "STAGES" : "SZÍNPADOK",
              value: lang === "en" ? "4 stages" : "4 színpad",
            },
        ...
        <View style={styles.homeSectionHeader}>
          <Text style={styles.homeSectionTitle}>
            {lang === "en" ? "Featured Artists" : "Kiemelt fellépők"}
          </Text>
            ...
            return (
              <View key={artist.id} style={styles.featuredCard}>
                ...
                <View style={styles.featuredCardOverlay}>
                  ...
                  >
                    <Text
                      style={[styles.featuredStagePillText, { color: accent }]}
                    >
                      {artist.stage}
                    </Text>
                  </View>
                  ...
                  <Text style={styles.featuredCardMeta}>
                    ...
                    {lang === "en" ? `Day ${artist.day}` : `${artist.day}. nap`}
                  </Text>
                </View>
              </View>
            );
...
function ScheduleScreen({
  ...
  const filteredPerformers =
    dayFilter === "all"
      ? sorted
      : sorted.filter((performer) => performer.day === dayFilter);
        ...
        return (
          ...
          >
            <Ionicons
              name={view.icon}
              size={13}
              color={active ? THEME.accent : "rgba(168,85,247,0.45)"}
            />
            <Text
              style={[
    ...
    <FlatList
      ...
      renderItem={({ item }) => (
        <PerformerCard
          ...
          onPress={() => setSelectedPerformer(item)}
          lang={lang}
        />
      )}
    />
        ...
        <View key={item.id} style={styles.timelineRow}>
          ...
          >
            <View style={styles.timelineCardHeader}>
              <Image
                source={getPerformerImage(item.id)}
              ...
              <View style={styles.timelineCardInfo}>
                ...
                <Text style={styles.performerDetails}>
                  {item.stage} · {formatScheduleDay(item.day, lang)}
                </Text>
          ...
          >
            <View style={styles.gridCardTop}>
              <Text style={styles.gridTime}>
                {formatScheduleDay(item.day, lang)} · {item.startTime} –{" "}
                {item.endTime}
              </Text>
  ...
  return (
    <View style={styles.scheduleScreen}>
      ...
      <PerformerDetailModal
        ...
        lang={lang}
        isFavorite={
          selectedPerformer ? favorites.includes(selectedPerformer.id) : false
        }
...
function PerformerDetailModal({
  ...
  const description =
    (lang === "en" ? performer.description_en : performer.description_hu) ||
    performer.description_hu ||
    performer.description_en ||
    (lang === "en"
      ? "Description not available for this artist."
      : "Leírás nem érhető el ehhez az előadóhoz.");
  return (
    <Modal
      visible={!!performer}
      transparent
    ...
    >
      <View style={styles.performerModalBackdrop}>
        ...
        <View style={styles.performerModalCard}>
          <Image
            source={getPerformerImage(performer.id)}
            style={styles.performerModalBackgroundImage}
            resizeMode="cover"
          />
          ...
          <View style={styles.performerModalContent}>
            <View style={styles.performerModalTopRow}>
              <View style={{ flex: 1 }}>
                <Text style={styles.performerModalEyebrow}>
                  {t.artistDetail}
                </Text>
                <Text style={styles.performerModalName}>{performer.name}</Text>
              </View>
              <TouchableOpacity
                style={styles.performerModalCloseBtn}
                onPress={onClose}
              >
            ...
            <View style={styles.performerModalMetaRow}>
              <View style={styles.performerModalMetaChip}>
                <Ionicons
                  ...
                  color={THEME.accent}
                />
                <Text style={styles.performerModalMetaText}>
                  {performer.stage}
                </Text>
              </View>
              <View style={styles.performerModalMetaChip}>
                ...
                <Text style={styles.performerModalMetaText}>
                  {formatScheduleDay(performer.day, lang)} ·{" "}
                  {performer.startTime} – {performer.endTime}
                </Text>
              </View>
            </View>

            <Text style={styles.performerModalSectionTitle}>
              {lang === "en" ? "About the artist" : "Az előadóról"}
            </Text>
            <Text style={styles.performerModalDescription}>{description}</Text>

            <TouchableOpacity
              style={styles.performerModalFavBtn}
  ...
  return (
    ...
    >
      ...
      <View style={styles.cardInfo}>
        <Text style={styles.performerName}>{item.name}</Text>
        <Text style={styles.performerDetails}>
          {item.stage} · {formatScheduleDay(item.day, lang)} · {item.startTime}{" "}
          – {item.endTime}
        </Text>
        <Text style={styles.performerCardHint}>
          {lang === "en" ? "Open details" : "Részletek megnyitása"}
        </Text>
        {conflictNames && conflictNames.length > 0 && (
          <View style={styles.conflictRow}>
            <Ionicons name="warning-outline" size={12} color="#f59e0b" />
            <Text style={styles.conflictText}>
              {lang === "en" ? "Conflict: " : "Ütközés: "}
              {conflictNames.join(", ")}
            </Text>
          </View>
        )}
...
function EventVisual({
  ...
  return (
    <View
      style={[
        styles.eventVisualFrame,
        compact && styles.eventVisualFrameCompact,
      ]}
    >
      <Svg
        width="100%"
      ...
      >
        ...
        />
        <Path
          d={`M26 ${h * 0.7} C92 ${h * 0.42} 126 ${h * 0.44} 186 ${h * 0.64} C240 ${h * 0.82} 286 ${h * 0.5} 342 ${h * 0.64}`}
        ...
        {[0, 1, 2, 3, 4].map((i) => (
          <Circle
            ...
            cy={compact ? 66 : 90}
            r={compact ? 8 : 11}
            fill={i % 2 === 0 ? accent : "#f0e8ff"}
            opacity={0.78}
          />
        ))}
        <Path
          d={`M0 ${h - 48} C36 ${h - 72} 72 ${h - 50} 110 ${h - 68} C150 ${h - 88} 194 ${h - 50} 232 ${h - 70} C282 ${h - 96} 318 ${h - 58} 360 ${h - 78} L360 ${h} L0 ${h} Z`}
          fill="rgba(34,18,58,0.42)"
        />
        ...
        <Path
          d={`M0 ${h - 54} L360 ${h - 54} L360 ${h} L0 ${h} Z`}
          fill="url(#stageFade)"
        />
      </Svg>
    </View>
              ...
              {GASTRO_CATEGORIES.map((cat) => {
                ...
                return (
                  <TouchableOpacity
                    key={cat}
                    style={[
                      styles.gastroCategoryTile,
                      active && styles.gastroCategoryTileActive,
                    ]}
                  ...
                  >
                    <View style={styles.gastroCategoryTileTopRow}>
                      <View
                        style={[
                          styles.gastroCategoryIconCircle,
                          active && styles.gastroCategoryIconCircleActive,
                        ]}
                      >
                        <Ionicons
                          name={meta.icon}
                      ...
                      <View style={styles.gastroCategoryTextBlock}>
                        <Text
                          style={[
                            styles.gastroCategoryTileTitle,
                            active && styles.gastroCategoryTileTitleActive,
                          ]}
                        >
                        ...
                        <Text
                          style={[
                            styles.gastroCategoryTileMeta,
                            active && styles.gastroCategoryTileMetaActive,
                          ]}
                        >
          ...
          <View style={styles.gastroCard}>
            {GASTRO_IMAGE_ASSETS[item.id] ? (
              <View style={styles.gastroImageWrap}>
                <Image
                  source={GASTRO_IMAGE_ASSETS[item.id]}
                  style={styles.gastroCardImage}
                  resizeMode="cover"
                />
                <View
                  style={[
                    styles.gastroImageTint,
            ...
            <View style={styles.gastroCardBody}>
              <View style={styles.gastroCardHeader}>
                ...
                >
                  <Ionicons
                    name={GASTRO_CATEGORY_META[item.category].icon}
                    size={22}
                    color={item.color}
                  />
                </View>
              ...
              <View style={styles.gastroOffers}>
                <Text style={styles.gastroOffersLabel}>
                  {t.recommendedItems}
                </Text>
...
function SponsorsScreen({
  ...
  return (
    <View style={styles.infoScreenContainer}>
      <Text
        style={[styles.sectionTitle, { textAlign: "center", marginTop: 8 }]}
      >
        {t.sponsorsTitle}
      </Text>
      <FlatList
        ...
        columnWrapperStyle={
          sponsorColumns > 1 ? styles.sponsorColumnWrapper : undefined
        }
        renderItem={({ item }) => (
          <View
            style={[
              styles.sponsorCard,
              sponsorColumns === 1 && styles.sponsorCardSingle,
            ]}
          >
            <SponsorLogo
              sponsorId={item.id}
...
function MoreScreen({
  ...
  const items: {
  ...
  }[] = [
    {
      ...
      subtitle:
        lang === "en"
          ? "My schedule and conflicts"
          : "Saját menetrend és ütközések",
      icon: "heart",
      onPress: onGoToFavorites,
    ...
    },
    {
      ...
      subtitle:
        lang === "en"
          ? "Stands, offers, and categories"
          : "Standok, ajánlatok, kategóriák",
      icon: "restaurant",
...
export default function App() {
  ...
  const handleTogglePerformance = (id: string) => {
    setSelectedPerformanceIds((prev) =>
      prev.includes(id)
        ? prev.filter((performanceId) => performanceId !== id)
        : [...prev, id],
    );
    setOrderComplete(false);
    setRefundRequested(false);
  ...
  const handlePurchase = () => {
    const selectedPerformancesForCheckout = performers.filter((p) =>
      selectedPerformanceIds.includes(p.id),
    );
    const noTimeConflicts =
      getPerformanceConflictPairs(selectedPerformancesForCheckout).length === 0;
    if (
      selectedTicketId &&
      ...
      const title =
        lang === "en" ? "Successful Purchase!" : "Sikeres vásárlás!";
      const message =
        lang === "en"
  ...
  return (
    ...
    >
      ...
      <View style={styles.header}>
        <TouchableOpacity
          style={[
            ...
            activeTab === "Home" && styles.headerBackBtnHidden,
          ]}
          onPress={goBack}
      ...
      <View style={styles.mainArea}>
        ...
        {activeTab === "Map" &&
          (festivalMap ? (
            <MapScreen map={festivalMap} lang={lang} t={t} />
          ) : (
            <View style={styles.mapScreen}>
        ...
        {activeTab === "Gastro" && (
          <GastroScreen onBack={goBack} lang={lang} t={t} />
        )}
        {activeTab === "Tickets" && (
          <TicketsScreen
            tickets={tickets}
...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    backgroundColor: "rgba(10,3,26,0.84)",
    alignItems: "center",
    borderBottomWidth: 1,
  ...
  ticketCta: {
    ...
    borderWidth: 1,
    borderColor: "rgba(245,208,254,0.52)",
    alignSelf: "center",
    width: "100%",
    maxWidth: 420,
    shadowColor: THEME.accent,
  ...
  ticketCard: {
    flexDirection: "row",
    backgroundColor: "rgba(72,34,112,0.58)",
    borderWidth: 1,
  ...
  checkoutBar: {
    ...
    paddingBottom: 10,
    borderTopWidth: 1,
    borderTopColor: "rgba(216,180,254,0.18)",
    backgroundColor: "rgba(17,6,30,0.96)",
    shadowColor: THEME.accent,
    shadowOpacity: 0.18,
    shadowRadius: 18,
    elevation: 10,
  ...
  performanceDayHeaderLeft: {
    flexDirection: "row",
    alignItems: "center",
    flex: 1,
    gap: 10,
  },
  performanceDayHeaderRight: {
    flexDirection: "row",
    alignItems: "center",
    gap: 8,
  },
  ...
  performanceDaySubtitle: {
    fontSize: 12,
    color: THEME.textSubtle,
    fontWeight: "700",
    marginTop: 3,
  },
  performanceDayWarningBadge: {
    flexDirection: "row",
    alignItems: "center",
    gap: 4,
    paddingHorizontal: 7,
  ...
  performanceTicketCard: {
    ...
    backgroundColor: "rgba(72,34,112,0.50)",
  },
  performanceTicketCardSelected: {
    borderColor: "rgba(245,208,254,0.52)",
    backgroundColor: "rgba(148,92,234,0.24)",
  },
  performanceTicketCardConflicted: {
    borderColor: "rgba(251,146,60,0.7)",
    backgroundColor: "rgba(249,115,22,0.10)",
  },
  performanceTicketVisual: {
    width: 78,
    height: 64,
    borderRadius: 24,
    overflow: "hidden",
  ...
  performanceTicketMeta: {
    fontSize: 11,
    color: THEME.textSubtle,
    fontWeight: "700",
    marginBottom: 6,
  },
  performanceTicketTimeRow: {
    flexDirection: "row",
    alignItems: "center",
    gap: 5,
  },
  performanceTicketTime: {
    fontSize: 11,
    color: THEME.textMuted,
    fontWeight: "700",
  },
  performanceTicketTimeConflicted: { color: "#fed7aa" },
  selectedPerformancePanel: {
    padding: 16,
    borderRadius: 24,
    borderWidth: 1,
    borderColor: THEME.borderStrong,
  ...
  selectedPerformanceMeta: {
    fontSize: 12,
    color: THEME.textMuted,
    fontWeight: "700",
    marginBottom: 12,
  },
  selectedPerformanceLine: {
    paddingVertical: 8,
    borderBottomWidth: 1,
    borderBottomColor: "rgba(255,255,255,0.07)",
  },
  performanceConflictPanel: {
    padding: 14,
    borderRadius: 24,
    borderWidth: 1,
  ...
  performanceConflictHeader: {
    flexDirection: "row",
    alignItems: "center",
    gap: 8,
    marginBottom: 8,
  },
  performanceConflictTitle: {
    fontSize: 14,
    color: "#fed7aa",
    fontWeight: "900",
  },
  performanceConflictText: {
    fontSize: 12,
    color: "rgba(255,237,213,0.88)",
    lineHeight: 18,
    marginBottom: 8,
  },
  performanceConflictItem: {
    fontSize: 12,
    color: "#fed7aa",
    lineHeight: 18,
    fontWeight: "700",
  ...
  mapNorth: {
    ...
    width: 26,
    height: 26,
    backgroundColor: "rgba(34,18,58,0.55)",
    borderRadius: 13,
    borderWidth: 0.5,
  ...
  scheduleViewChipActive: {
    ...
    borderColor: "rgba(245,208,254,0.42)",
  },
  ...
  card: {
    flexDirection: "row",
    alignItems: "center",
    backgroundColor: "rgba(64,28,104,0.58)",
    borderWidth: 1,
    borderColor: "rgba(216,180,254,0.24)",
    borderRadius: 28,
    marginBottom: 14,
  ...
  performerModalBackdrop: {
    flex: 1,
    backgroundColor: "rgba(3,1,8,0.78)",
    justifyContent: "center",
    paddingHorizontal: 18,
  },
  performerModalCard: {
  ...
  performerModalTopRow: {
    flexDirection: "row",
    alignItems: "flex-start",
    gap: 12,
    marginBottom: 14,
  },
  performerModalEyebrow: {
    color: THEME.accent,
    fontSize: 10,
    fontWeight: "900",
    letterSpacing: 1.8,
  ...
  performerModalMetaRow: {
    flexDirection: "row",
    flexWrap: "wrap",
    gap: 8,
    marginBottom: 18,
  },
  performerModalMetaChip: {
    flexDirection: "row",
    alignItems: "center",
    gap: 6,
    paddingHorizontal: 10,
  ...
  performerModalMetaText: {
    color: THEME.textMuted,
    fontSize: 12,
    fontWeight: "800",
  },
  performerModalSectionTitle: {
    color: THEME.text,
    fontSize: 15,
    fontWeight: "900",
    marginBottom: 8,
  },
  performerModalDescription: {
    color: THEME.textMuted,
    fontSize: 14,
    lineHeight: 22,
    marginBottom: 18,
  ...
  navBar: {
    flexDirection: "row",
    backgroundColor: "rgba(5,1,14,0.97)",
    paddingBottom: 24,
    paddingTop: 12,
    borderTopWidth: 1,
    borderTopColor: "rgba(216,180,254,0.18)",
  ...
  dayFilterRow: {
    ...
    gap: 8,
    paddingVertical: 6,
    alignItems: "center", // <-- Ez akadályozza meg a nyúlást
  },
  dayFilterChip: {
    paddingHorizontal: 16,
    paddingVertical: 8, // Picit nagyobb padding, hogy kényelmesen lehessen rányomni
    borderRadius: 20,
    borderWidth: 0.8,
    borderColor: THEME.border,
    backgroundColor: THEME.surface,
