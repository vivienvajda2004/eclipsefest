...
// Modern, élénk fesztivál (Coachella) app irány – mély sötétlila alap, neon pink/magenta glow, üveges kapszula gombok
const THEME = {
	bg: "#0a0410",
	...
	return (
		<View style={styles.gastroScreen}>
			<FlatList
				...
				renderItem={({ item }) => (
					<View style={[styles.gastroCard, { minHeight: 480, justifyContent: "flex-end" }]}>
						<Image
						...
						<Svg width="100%" height="100%" style={StyleSheet.absoluteFillObject}>
							<Defs>
								<LinearGradient id={`fade-${item.id}`} x1="0" y1="0" x2="0" y2="1">
									<Stop offset="0" stopColor="#10091c" stopOpacity="0" />
									<Stop offset="0.35" stopColor="#10091c" stopOpacity="0.1" />
									<Stop offset="0.55" stopColor="#10091c" stopOpacity="0.85" />
						...
						<View style={[styles.gastroCardBody, { paddingTop: 20 }]}>
...
const styles = StyleSheet.create({
	...
	homeScroll: { alignItems: "center", paddingBottom: 120, paddingTop: 8 },
	...
	homeHeroEyebrow: { color: "rgba(245,208,254,0.92)", fontSize: 11, letterSpacing: 0.4, fontWeight: "900", fontFamily: FONTS.ui, marginBottom: 8 },
	homeHeroTitle: { color: "#fff", fontSize: 26, lineHeight: 31, fontWeight: "700", fontFamily: FONTS.heading, letterSpacing: -0.5 },
	...
	ticketCard: { flexDirection: "row", backgroundColor: "rgba(255,255,255,0.06)", borderWidth: 1, borderColor: "rgba(216,180,254,0.18)", borderRadius: 32, marginBottom: 16, overflow: "hidden", position: "relative", shadowColor: THEME.accent, shadowOpacity: 0.12, shadowRadius: 16, elevation: 5 },
	...
	timelineCard: { flex: 1, marginLeft: 8, marginBottom: 12, borderRadius: 24, borderWidth: 1, borderColor: THEME.border, backgroundColor: "rgba(255,255,255,0.06)", overflow: "hidden" },
	...
	// Navigáció
	navBar: { flexDirection: "row", backgroundColor: "rgba(5,1,14,0.96)", paddingBottom: 120, paddingTop: 12, borderTopWidth: 1, borderTopColor: "rgba(216,180,254,0.14)", shadowColor: THEME.accent, shadowOpacity: 0.18, shadowRadius: 18, elevation: 12 },
	navItem: { flex: 1, alignItems: "center", gap: 4 },
	navIconWrap: { width: 46, height: 40, borderRadius: 24, alignItems: "center", justifyContent: "center" },
	...
	gastroList: { paddingBottom: 120 },
	gastroCard: { backgroundColor: "rgba(255,255,255,0.055)", borderWidth: 1, borderColor: "rgba(216,180,254,0.14)", borderRadius: 32, marginHorizontal: 16, marginBottom: 18, overflow: "hidden", shadowColor: THEME.accent, shadowOpacity: 0.12, shadowRadius: 16, elevation: 5 },
	...
	gastroIconBox: { width: 52, height: 52, borderRadius: 24, alignItems: "center", justifyContent: "center", borderWidth: 1.2 },
